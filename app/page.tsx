    ...
    >
      ...
      <header className="px-5 md:px-8 pt-7 pb-5 border-b border-card relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="flex items-start justify-between gap-4 flex-wrap">
            ...
            {/* SEARCH BAR */}
            <div style={{border:'1px solid gray', borderRadius:'8px' }} className="w-full sm:w-72 md:w-80">
              <div
      ...
      <div className="max-w-8xl mx-auto px-5 md:px-8 py-5">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          {/* LEFT: DRAWER LIST */}
          <aside className="md:col-span-2 min-w-0">
            <div className="rounded-lg overflow-hidden border border-card bg-card">
              <button
                onClick={() => {
                  setActive(null);
                  setQuery("");
                ...
                style={{
                  ...
                  background: active === null ? "rgba(255,179,0,0.08)" : "transparent",
                  cursor: "pointer",
                }}
              >
                  ...
                  <div key={cat.slug}>
                    <button
                      ...
                      style={{
                        ...
                        cursor: "pointer",
                        // @ts-ignore custom property for the pulse color
                        "--tb-pulse-color": isOpen ? undefined : `${accent}55`,
                      }}
                    >
                      <span
                      ...
                      <span className="flex-1 min-w-0">
                        ...
                        <span
                          ...
                          style={{ color: "var(--foreground)", opacity: isOpen ? 1 : 0.85 }}
                        >
                          {cat.name}
                        </span>
                      </span>
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <span
                        ...
                        style={{ fontFamily: "'IBM Plex Mono', monospace", color: tool.accent }}
                      >
          ...
          <aside className="md:col-span-3 min-w-0">
            ...
            <div className="rounded-lg border border-card bg-card mt-4 p-3.5">
              <p
                ...
                style={{ fontFamily: "'IBM Plex Mono', monospace", color: "#FFB300" }}
              >
                Suggest a tool
              </p>
